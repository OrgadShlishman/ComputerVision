...
def main():
    ...
    fake_image_idx = random.choice(range(int(len(fakes_dataset_train.real_image_names)), int(len(fakes_dataset_train))))
    ...
    fake_image_idx = random.choice(range(int(len(synthetic_dataset_train.real_image_names)), int(len(synthetic_dataset_train))))
    plt.subplot(2, 2, 3)
    plt.imshow(normalize(
